...
export const bookADemoFormData = [
  {
    ...
    hint: "This helps us tailor the demo to your service type.",
    id: "organisationType",
    multiSelect: false,
    image: popupImage1,
    fields: [
      { id: "", type: "option", value: "NDIS Provider", displayName: "NDIS Provider" },
      { id: "", type: "option", value: "Aged Care Service", displayName: "Aged Care Service" },
      { id: "", type: "option", value: "Childcare", displayName: "Childcare" },
      { id: "", type: "option", value: "Allied Health", displayName: "Allied Health" },
      { id: "", type: "option", value: "SIL", displayName: "SIL" },
      { id: "", type: "option", value: "Other", displayName: "Other" },
    ],
  },
  {
    text: "Team & Goals",
    question: "Who will use TesseractApps?",
    hint: "Select all that apply – helps us show relevant features.",
    id: "teamRoles",
    multiSelect: true,
    image: popupImage2,
    fields: [
      { id: "", type: "option", value: "Administrator", displayName: "Administrator" },
      { id: "", type: "option", value: "Roster/Scheduling Manager", displayName: "Roster/Scheduling Manager" },
      { id: "", type: "option", value: "Support Worker / Carer", displayName: "Support Worker / Carer" },
      { id: "", type: "option", value: "Plan Manager / Coordinator", displayName: "Plan Manager / Coordinator" },
      { id: "", type: "option", value: "Allied Health Professional", displayName: "Allied Health Professional" },
      { id: "", type: "option", value: "HR / Payroll Staff", displayName: "HR / Payroll Staff" },
      { id: "", type: "option", value: "Accountant / Finance", displayName: "Accountant / Finance" },
      { id: "", type: "option", value: "Manager / Supervisor", displayName: "Manager / Supervisor" },
      { id: "", type: "option", value: "Compliance Officer", displayName: "Compliance Officer" },
      { id: "", type: "option", value: "Other", displayName: "Other" },
    ],
  },
  {
    text: "Team & Goals",
    question: "What are your main goals with TesseractApps?",
    hint: "Select the top goals so we can focus on what matters most.",
    id: "goals",
    multiSelect: true,
    image: popupImage3,
    fields: [
      { id: "", type: "option", value: "Save admin time", displayName: "Save admin time" },
      { id: "", type: "option", value: "Reduce audit risk", displayName: "Reduce audit risk" },
      { id: "", type: "option", value: "Simplify NDIS compliance", displayName: "Simplify NDIS compliance" },
      { id: "", type: "option", value: "Better reporting & insights", displayName: "Better reporting & insights" },
      { id: "", type: "option", value: "Streamline HR & Payroll", displayName: "Streamline HR & Payroll" },
    ],
  },
  {
    text: "Your Details",
    question: "Your details & schedule",
    hint: "We’ll schedule a personalised demo just for you.",
    id: "",
    multiSelect: false,
    image: popupImage4,
    fields: [
      ...
      { type: "input", id: "phoneNumber", displayName: "Phone Number", value: "" },
      { type: "input", id: "companyName", displayName: "Company Name", value: "" },
